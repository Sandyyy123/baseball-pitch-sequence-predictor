# Tarik Skubal Pitch Prediction

**Difficulty:** 9/10 &middot; **Task type:** Sequence / Multi-class
...
```bash
git clone https://github.com/Sandyyy123/liora-03-skubal-pitch.git
cd liora-03-skubal-pitch
